...
#cursor.execute("create database sra")
cursor.execute("use sra")
#cursor.execute("create table u
...
st.set_page_config(
   ...
   page_icon='./Logo/cv_analysis_logo',
)
def run():
    ...
    img = Image.open('./Logo/cv_analysis_logo.jpg')
    ...
    if choice == 'Normal User':
        ...
        if st.button('Login'):
            if ad_user == 'Machine_Learning' and ad_password == 'DSR123':
                st.success("Welcome DSR")
                # Display Data
